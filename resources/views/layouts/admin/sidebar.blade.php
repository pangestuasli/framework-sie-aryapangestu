            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                <li class="nav-item">
                    <a href="../../index.html" class="nav-link d-flex align-items-center">
                        ...
                        <span class="mt-1 ms-1 sidebar-text">{{Auth::login($user);}}</span>
                    </a>
                </li>
                <li class="nav-item nav-item {{ request()->routeIs('dashboard.*') ? 'active' : '' }} ">
                ...
                <li class="nav-item nav-item {{ request()->routeIs('pelanggan.*') ? 'active' : '' }} ">
                 ...
                 <li class="nav-item nav-item {{ request()->routeIs('produk.*') ? 'active' : '' }} ">
